...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/27 22:41:02 by msafflow          #+#    #+#             */
/*   Updated: 2020/11/28 19:48:35 by msafflow         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char *var_expand(char *orig_var_name)
{
	...
	t_symtab_entry *entry = get_symtab_entry(var_name);
...
{
	t_symtab_entry *entry = get_symtab_entry("IFS");
		...
		switch(str[i])
		{
			...
			/*
				...
				/* create a new struct for the field */
					t_word *fld = malloc(sizeof(t_word));
